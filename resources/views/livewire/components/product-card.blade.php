...
<div class="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
    {{-- 商品图片 --}}
    @if($product->picture)
    ...
    <div class="p-4 flex flex-col flex-1">
        {{-- 商品名称 --}}
        <flux:heading size="lg" class="line-clamp-2 mb-2">
            {{ $product->gd_name }}
        </flux:heading>

        {{-- 商品描述 --}}
        <flux:text class="line-clamp-2 mb-3 flex-1">
